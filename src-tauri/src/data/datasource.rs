...
use rusqlite::{params, vtab::array::Array, Transaction};
    ...
    pub fn substitute_root(&self, root_oid: i64, root_substitution_datasource: Datasource) -> Self {
        match self {
            ...
            Self::MasterTable {
                ...
                parent_datasource: Box::new(
                    parent_datasource.substitute_root(root_oid, root_substitution_datasource),
                ),
    ...
    pub fn get_alias(&self) -> String {
        match self {
            ...
            Self::MasterTable {
                parent_datasource,
                table_oid,
            } => format!("{}_MASTER{table_oid}", parent_datasource.get_alias()),
            Self::InheritorTable {
                parent_datasource,
                table_oid,
            } => format!("{}_INHERITOR{table_oid}", parent_datasource.get_alias()),
            Self::Column {
                parent_datasource,
                column,
