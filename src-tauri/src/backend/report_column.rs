...
pub fn create(report_oid: i64, column_name: &str, column_type: column_type::MetadataColumnType, column_ordering: Option<i64>, column_style: &str, is_nullable: bool, is_unique: bool, is_primary_key: bool) -> Result<i64, error::Error> {
